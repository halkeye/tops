 ...
 */
require_once dirname(__FILE__)."/../Auth/Yadis/PlainHTTPFetcher.php";
require_once dirname(__FILE__)."/../Auth/Yadis/ParanoidHTTPFetcher.php";
require_once dirname(__FILE__)."/../Auth/OpenID/BigMath.php";
require_once dirname(__FILE__)."/../Auth/OpenID/URINorm.php";
